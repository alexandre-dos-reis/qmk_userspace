...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMBOLS] = LAYOUT(
        ...
        _______,   _______,    _______,    KC_TILDE,     KC_PIPE,      _______,     _______,    _______,  _______,                 KC_UNDERSCORE,           KC_EQUAL,            KC_LEFT_CURLY_BRACE, KC_RIGHT_CURLY_BRACE,  _______,
                                                         _______,      _______,     _______,    _______,  KC_RIGHT_ALT,            XXXXXXX
    ),

    [_NUMBERS_AND_ARROWS] = LAYOUT(
        _______,    _______,    _______,    _______,      _______,      _______,                          _______,                 _______,                 _______,             _______,             _______,               _______,
    ...
    [_ACCENTS] = LAYOUT(
        ...
        _______,    _______,    _______,    ACC_C_CED,    _______,      _______,     _______,    _______, _______,                 _______,                 _______,             _______,             XXXXXXX,               _______,
